...
void main() {
    ...
    EMF_SoftWareUART_Transmit_Byte(EMF_GIO_GetConfigState_1Pin_Return_Mode_1Input0Output(GIOB, 7));
    EMF_SoftWareUART_Transmit_Byte(EMF_GIO_GetConfigState_1Pin_Return_Mode_1Input0Output(GIOB, 6));
    EMF_SoftWareUART_Transmit_Byte(EMF_GIO_GetConfigState_1Pin_Return_Mode_1Input0Output(GIOB, 5));
    EMF_SoftWareUART_Transmit_Byte(EMF_GIO_GetConfigState_1Pin_Return_Mode_1Input0Output(GIOB, 4));
    EMF_SoftWareUART_Transmit_Byte(EMF_GIO_GetConfigState_1Pin_Return_Mode_1Input0Output(GIOB, 3));
    EMF_SoftWareUART_Transmit_Byte(EMF_GIO_GetConfigState_1Pin_Return_Mode_1Input0Output(GIOB, 2));
    EMF_SoftWareUART_Transmit_Byte(EMF_GIO_GetConfigState_1Pin_Return_Mode_1Input0Output(GIOB, 1));
    EMF_SoftWareUART_Transmit_Byte(EMF_GIO_GetConfigState_1Pin_Return_Mode_1Input0Output(GIOB, 0));
    EMF_SoftWareUART_Transmit_Byte('\n');

    EMF_SoftWareUART_Transmit_Byte(EMF_GIO_GetConfigState_1Pin_Return_Pull_0PullNO_1PullUp(GIOB, 7));
    EMF_SoftWareUART_Transmit_Byte(EMF_GIO_GetConfigState_1Pin_Return_Pull_0PullNO_1PullUp(GIOB, 6));
    EMF_SoftWareUART_Transmit_Byte(EMF_GIO_GetConfigState_1Pin_Return_Pull_0PullNO_1PullUp(GIOB, 5));
    EMF_SoftWareUART_Transmit_Byte(EMF_GIO_GetConfigState_1Pin_Return_Pull_0PullNO_1PullUp(GIOB, 4));
    EMF_SoftWareUART_Transmit_Byte(EMF_GIO_GetConfigState_1Pin_Return_Pull_0PullNO_1PullUp(GIOB, 3));
    EMF_SoftWareUART_Transmit_Byte(EMF_GIO_GetConfigState_1Pin_Return_Pull_0PullNO_1PullUp(GIOB, 2));
    EMF_SoftWareUART_Transmit_Byte(EMF_GIO_GetConfigState_1Pin_Return_Pull_0PullNO_1PullUp(GIOB, 1));
    EMF_SoftWareUART_Transmit_Byte(EMF_GIO_GetConfigState_1Pin_Return_Pull_0PullNO_1PullUp(GIOB, 0));
    EMF_SoftWareUART_Transmit_Byte('\n');
    ...
    EMF_SoftWareUART_Transmit_Byte(EMF_GIO_GetWriteState_AllPins(GIOB));
    EMF_SoftWareUART_Transmit_Byte('\n');
