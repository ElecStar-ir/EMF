...
void main() {
    ...
    SoftWareUART_Transmit_Byte(EMF_GIO_GetConfigState_1Pin_Return_Mode_1Input0Output(GIOB, 7));
    SoftWareUART_Transmit_Byte(EMF_GIO_GetConfigState_1Pin_Return_Mode_1Input0Output(GIOB, 6));
    SoftWareUART_Transmit_Byte(EMF_GIO_GetConfigState_1Pin_Return_Mode_1Input0Output(GIOB, 5));
    SoftWareUART_Transmit_Byte(EMF_GIO_GetConfigState_1Pin_Return_Mode_1Input0Output(GIOB, 4));
    SoftWareUART_Transmit_Byte(EMF_GIO_GetConfigState_1Pin_Return_Mode_1Input0Output(GIOB, 3));
    SoftWareUART_Transmit_Byte(EMF_GIO_GetConfigState_1Pin_Return_Mode_1Input0Output(GIOB, 2));
    SoftWareUART_Transmit_Byte(EMF_GIO_GetConfigState_1Pin_Return_Mode_1Input0Output(GIOB, 1));
    SoftWareUART_Transmit_Byte(EMF_GIO_GetConfigState_1Pin_Return_Mode_1Input0Output(GIOB, 0));
    SoftWareUART_Transmit_Byte('\n');

    SoftWareUART_Transmit_Byte(EMF_GIO_GetConfigState_1Pin_Return_Pull_0PullNO_1PullUp(GIOB, 7));
    SoftWareUART_Transmit_Byte(EMF_GIO_GetConfigState_1Pin_Return_Pull_0PullNO_1PullUp(GIOB, 6));
    SoftWareUART_Transmit_Byte(EMF_GIO_GetConfigState_1Pin_Return_Pull_0PullNO_1PullUp(GIOB, 5));
    SoftWareUART_Transmit_Byte(EMF_GIO_GetConfigState_1Pin_Return_Pull_0PullNO_1PullUp(GIOB, 4));
    SoftWareUART_Transmit_Byte(EMF_GIO_GetConfigState_1Pin_Return_Pull_0PullNO_1PullUp(GIOB, 3));
    SoftWareUART_Transmit_Byte(EMF_GIO_GetConfigState_1Pin_Return_Pull_0PullNO_1PullUp(GIOB, 2));
    SoftWareUART_Transmit_Byte(EMF_GIO_GetConfigState_1Pin_Return_Pull_0PullNO_1PullUp(GIOB, 1));
    SoftWareUART_Transmit_Byte(EMF_GIO_GetConfigState_1Pin_Return_Pull_0PullNO_1PullUp(GIOB, 0));
    SoftWareUART_Transmit_Byte('\n');
    ...
    SoftWareUART_Transmit_Byte(EMF_GIO_GetWriteState_AllPins(GIOB));
    SoftWareUART_Transmit_Byte('\n');
